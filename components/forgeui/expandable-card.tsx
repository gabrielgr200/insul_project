  ...
  return (
    <div className="relative">
      <AnimatePresence>
        {current ? (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="bg-transparent pointer-events-none fixed inset-0 z-10 backdrop-blur-xl"
          />
        ) : null}
      </AnimatePresence>
        ...
        {current ? (
          <>
            <div className="absolute inset-0 z-10 grid place-items-center">
              <motion.div
                className="poppins flex h-fit w-full max-w-xl cursor-pointer flex-col items-start gap-4 overflow-hidden rounded-md border border-white/20 bg-white/10 p-4 backdrop-blur-xl dark:border-neutral-800/60 dark:bg-white/5"
                ref={ref}
                ...
                <div className="flex w-full items-center gap-4">
                  ...
                  <div className="flex grow items-center justify-between">
                    <div className="flex w-full flex-col gap-0.5">
                      ...
                      <motion.div
                        className="flex flex-row gap-2 text-xs text-white/50"
      ...
      <div className={cn("relative flex items-start p-6", className)}>
        <div className="relative grid w-full grid-cols-1 gap-4 px-2 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((item) => (
            <motion.div
              ...
              className="poppins flex w-full cursor-pointer flex-row items-center gap-4 rounded-sm bg-white/10 p-2 shadow-sm ring-1 shadow-black/10 ring-black/10 backdrop-blur-xl md:p-4 dark:bg-white/5 dark:ring-neutral-800/60"
              onClick={() => {
                setCurrent(item);
              }}
            >
